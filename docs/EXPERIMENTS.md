...
The long-context suite is where the conditions separate. On longbench, MCTP matches the accuracy
of the full transcript (50% against 51%) while delivering about one sixty-ninth of the context
(180 tokens against 12,360), and it scores above both same-model summarization and TF-IDF
retrieval. This is the mechanism working as intended: it holds the accuracy of sending everything
